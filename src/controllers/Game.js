...
module.exports = {
  async store(
    ...
    const queryInsert = `INSERT INTO games (gameId,
      ...
      awayCornersHt,
      awayCornersFt,
      analysis) VALUES (${gameId}, "${gameDate}", "${homeName}", ${homeId}, ${homeAnalyzedGames}, ${homeGoalsHt}, ${homeGoalsFt}, ${homeCornersHt}, ${homeCornersFt}, "${awayName}", ${awayId}, ${awayAnalyzedGames}, ${awayGoalsHt}, ${awayGoalsFt}, ${awayCornersHt}, ${awayCornersFt}, "${analysis}")`;
    db.serialize(() => {
